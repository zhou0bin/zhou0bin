...
template <typename T>
constexpr bool is_observer_v = std::is_base_of<::midware::diag::script::sigslot::detail::observer_type,
...
private:
    template <typename, typename...>
    friend class ::midware::diag::script::sigslot::signal_base;
...
public:
     ...
     * @param[in] gid an identifier that can be used to order slot execution
     ...
     * observer
     *
     * @param[in] pmf a pointer over member function
     * @param[in] ptr an object pointer derived from observer
     * @param[in] gid an identifier that can be used to order slot execution
     * @return a connection object that can be used to interact with the slot
     */
     ...
     *
     * @param[in] pmf a pointer over member function
     * @param[in] ptr an object pointer
     * @param[in] gid an identifier that can be used to order slot execution
     * @return a connection object that can be used to interact with the slot
     */
    template <typename Pmf, typename Ptr>
     ...
     *
     * @param[in] pmf a pointer over member function
     * @param[in] ptr a trackable object pointer
     * @param[in] gid an identifier that can be used to order slot execution
     * @return a connection object that can be used to interact with the slot
     */
    template <typename Pmf, typename Ptr>
