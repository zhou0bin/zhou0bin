...
#ifndef UDS_INF_COMMON_MULTI_BYTE_TYPE_H_
#define UDS_INF_COMMON_MULTI_BYTE_TYPE_H_
...
uint8_t GetByte(const T& value, const size_t byte_offset)
{
    if (byte_offset >= sizeof(T)) {
        std::out_of_range e("MultiByteType byte_offset out of range");
        throw e;
    }
    return static_cast<uint8_t>(((value >> (byte_offset * 8U)) & 0xFFU));
}
