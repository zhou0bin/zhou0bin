#ifndef __ASF_DIAG_COMMUNICATION_DIAG_LIBNET_CLIENT_H__
#define __ASF_DIAG_COMMUNICATION_DIAG_LIBNET_CLIENT_H__
...
private:
    ...
    {
    public:
        PipelineFactory(Client * const host);
#ifdef USE_FS_LIBNET
...
#endif // __ASF_DIAG_COMMUNICATION_DIAG_LIBNET_CLIENT_H__
