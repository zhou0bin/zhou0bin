#ifndef __ASF_DIAG_COMMUNICATION_DIAG_LIBNET_PROTOCOL_H__
#define __ASF_DIAG_COMMUNICATION_DIAG_LIBNET_PROTOCOL_H__
...
class ProtocolEncoder : public libnet::OutboundHandler<TlvMsg&&, std::unique_ptr<IoBuffer> >
{
public:
#ifdef USE_FS_LIBNET
...
class ProtocolDecoder : public libnet::InboundHandler<libnet::BufferQueue&&, TlvMsg&&>
{
public:
#ifdef USE_FS_LIBNET
...
#endif // __ASF_DIAG_COMMUNICATION_DIAG_LIBNET_PROTOCOL_H__
