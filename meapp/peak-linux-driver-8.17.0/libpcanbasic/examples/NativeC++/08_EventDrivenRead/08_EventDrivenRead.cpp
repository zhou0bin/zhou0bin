...
/*
 * 08_EventDrivenRead.cpp - PCANBasic Example: EventDrivenRead
 *
...
{
	// Gets the handle of the Receive-Event.
	int fd;
...
{
    UINT64 microsTimestamp = itsTimeStamp.micros + (1000ULL * itsTimeStamp.millis) + (0x100000000ULL * 1000ULL * itsTimeStamp.millis_overflow);
